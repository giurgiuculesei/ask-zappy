...
export default function Filters({
    ...
    const scheduleUrlUpdate = useCallback((next: typeof local) => {
    ...
    return (
        <div className="top-0 z-30 border-b border-slate-200 bg-slate-50/80 backdrop-blur">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <form className="py-3 flex flex-wrap items-center gap-3 justify-center xl:justify-between" action="" method="GET">
                    {/* Paper */}
                    ...
                    <div className="w-full max-w-md mx-auto xl:w-auto xl:mx-0 xl:ml-auto">
                        <div className="relative w-full">
                            <svg className="absolute left-3 top-2.5 h-4 w-4 text-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M21 21l-4.35-4.35m1.1-4.4a6.75 6.75 0 11-13.5 0 6.75 6.75 0 0113.5 0z" />
                            </svg>
                            <input
                                type="search"
                                name="q"
                                ...
                                onKeyDown={(e) => {
                                    if (e.key === 'Enter') scheduleUrlUpdate(local);
                                }}
